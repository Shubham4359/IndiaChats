...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mviewusername=findViewById(R.id.viewusername5);
        ...
        storageReference.child("Images").child(firebaseAuth.getUid()).child("Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                Toast.makeText(getApplicationContext(),"Changed The Photo",Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                mviewusername.setText(muser.getUsername());
                Toast.makeText(getApplicationContext(),"Changed The Name",Toast.LENGTH_SHORT).show();
                Log.d("Profile", "onDataChange: "+mviewusername.toString());
            }
