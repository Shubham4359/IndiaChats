...
public class setprofile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mgetusername=findViewById(R.id.getusername1);
        mgetuserimage=findViewById(R.id.getuserimage1);
        mgetuserimageinimageview=findViewById(R.id.getuserimageinimageview1);
        msaveprofile=findViewById(R.id.saveProfile1);
        mprogressbarofsetprofile=findViewById(R.id.progressbarofsetProfile1);
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ininame=mgetusername.getText().toString();
                if(ininame.isEmpty())
                {
